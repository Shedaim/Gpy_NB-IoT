...
from sensors.lcd_api import LcdApi
...
class GpioLcd(LcdApi):
    def __init__(self, rs_pin, enable_pin, d0_pin=None, d1_pin=None,
        ...
        sleep_ms(100)   # Allow LCD time to powerup
        # Send reset 3 times
        self.hal_write_init_nibble(self.LCD_FUNCTION_RESET)
        sleep_ms(10)    # need to delay at least 4.1 msec
        self.hal_write_init_nibble(self.LCD_FUNCTION_RESET)
        sleep_ms(2)
        self.hal_write_init_nibble(self.LCD_FUNCTION_RESET)
        sleep_ms(2)
    ...
    def hal_pulse_enable(self):
        ...
        sleep_ms(1)       # Enable pulse needs to be > 450 nsec
        self.enable_pin.value(0)
        sleep_ms(100)     # Commands need > 37us to settle
